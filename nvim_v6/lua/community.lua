...
return {
  ...
  --
  -- NOTE: Cloned to plugins/ to prevent > 100 meta index astrocore bug
  ...
  -- These packages don't has astrocore as a spec/dependency or isn't overriden in plugins/ folder
  -- So they are safe to keep in community.lua
