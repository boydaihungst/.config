      ...
      opts = {
        mappings = {
          n = {
            ...
            [prefix .. "c"] = { "<cmd>CodeCompanionChat Toggle<cr>", desc = "Toggle chat" },
            [prefix .. "p"] = { "<cmd>CodeCompanionActions<cr>", desc = "Open action palette" },
            [prefix .. "q"] = { "<cmd>CodeCompanion<cr>", desc = "Open inline assistant" },
            [prefix] = { desc = require("astroui").get_icon("CodeCompanion", 1, true) .. "CodeCompanion" },
          },
          v = {
            [prefix .. "s"] = { "<cmd>CodeCompanionSummaries<cr>", desc = "Browse summaries" },
            [prefix .. "a"] = { "<cmd>CodeCompanionChat Add<cr>", desc = "Add selection to chat" },
            [prefix .. "c"] = { "<cmd>CodeCompanionChat Toggle<cr>", desc = "Toggle chat" },
            [prefix .. "p"] = { "<cmd>CodeCompanionActions<cr>", desc = "Open action palette" },
            [prefix .. "q"] = { "<cmd>CodeCompanion<cr>", desc = "Open inline assistant" },
            [prefix] = { desc = require("astroui").get_icon("CodeCompanion", 1, true) .. "CodeCompanion" },
