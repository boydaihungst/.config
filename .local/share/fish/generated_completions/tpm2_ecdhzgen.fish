...
complete -c tpm2_ecdhzgen -s u -l public -d 'Input ECC point Q'
complete -c tpm2_ecdhzgen -s k -l public-key -d 'Input ECC public key with point Q'
...
complete -c tpm2_ecdhzgen -s h -l help -d 'By default, it attempts to invoke the manpager for the tool, however, on fail…'
complete -c tpm2_ecdhzgen -s v -l version -d 'tool, supported tctis and exit.  [bu] 2'
complete -c tpm2_ecdhzgen -s V -l verbose -d 'tool prints to the console during its execution'
complete -c tpm2_ecdhzgen -s Q -l quiet -d '[bu] 2'
