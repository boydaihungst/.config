...
complete -c tpm2_nvreadlock -s C -l hierarchy -d 'Specifies the hierarchy used to authorize'
...
complete -c tpm2_nvreadlock -s h -l help -d 'By default, it attempts to invoke the manpager for the tool, however, on fail…'
complete -c tpm2_nvreadlock -s v -l version -d 'tool, supported tctis and exit.  [bu] 2'
complete -c tpm2_nvreadlock -s V -l verbose -d 'tool prints to the console during its execution'
complete -c tpm2_nvreadlock -s Q -l quiet -d '[bu] 2'
