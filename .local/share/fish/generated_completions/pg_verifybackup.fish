# pg_verifybackup
# Autogenerated from man page /usr/share/man/man1/pg_verifybackup.1.gz
...
complete -c pg_verifybackup -o 'P
.br
...
complete -c pg_verifybackup -s P
complete -c pg_verifybackup -l progress
