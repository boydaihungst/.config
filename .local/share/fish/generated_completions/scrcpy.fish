...
complete -c scrcpy -l audio-codec -d 'Select an audio codec (opus, aac, flac or raw).   Default is opus'
...
complete -c scrcpy -l camera-ar -d 'Select the camera size by its aspect ratio (+/- 10%)'
complete -c scrcpy -l camera-high-speed -d 'Enable high-speed camera capture mode'
complete -c scrcpy -l camera-id -d 'Specify the device camera id to mirror'
complete -c scrcpy -l camera-facing -d 'Select the device camera by its facing direction'
complete -c scrcpy -l camera-fps -d 'Specify the camera capture frame rate'
complete -c scrcpy -l camera-size -d 'Specify an explicit camera capture size'
...
complete -c scrcpy -l display-id -d 'Specify the device display id to mirror'
complete -c scrcpy -l display-orientation -d 'Set the initial display orientation'
...
complete -c scrcpy -s K -d 'Same as --keyboard=uhid'
complete -c scrcpy -l keyboard -d 'Select how to send keyboard inputs to the device'
...
complete -c scrcpy -l list-cameras -d 'List cameras available on the device'
...
complete -c scrcpy -l lock-video-orientation -d 'Lock capture video orientation to value'
complete -c scrcpy -s m -l max-size -d 'Limit both the width and height of the video to value'
complete -c scrcpy -s M -d 'Same as --mouse=uhid'
complete -c scrcpy -l max-fps -d 'Limit the framerate of screen capture (officially supported since Android 10,…'
complete -c scrcpy -l mouse -d 'Select how to send mouse inputs to the device'
...
complete -c scrcpy -l orientation -d 'Same as --display-orientation=value --record-orientation=value'
...
complete -c scrcpy -l pause-on-exit -d 'Configure pause on exit'
...
complete -c scrcpy -l record-format -d 'Force recording format (mp4, mkv, m4a, mka, opus, aac, flac or wav)'
complete -c scrcpy -l record-orientation -d 'Set the record orientation.   Possible values are 0, 90, 180 and 270'
...
complete -c scrcpy -l video-source -d 'Select the video source (display or camera)'
