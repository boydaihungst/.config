...
complete -c mpv -l title-bar -l no-title-bar -d '(Windows only) Play video with the window title bar'
...
complete -c mpv -l no-window-dragging -d 'Don\'t move the window when clicking on it and moving the mouse pointer'
...
complete -c mpv -l x11-wid-title -l no-x11-wid-title -d 'Whether or not to set the window title when mpv is embedded on X11 (default: …'
...
complete -c mpv -l term-remaining-playtime -l no-term-remaining-playtime -d 'When printing out the time on the terminal, show the remaining time adjusted …'
