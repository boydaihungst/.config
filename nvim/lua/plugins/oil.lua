...
return {
  ...
  opts = {
    ...
    keymaps = {
      ...
      ["<BS>"] = { "actions.toggle_hidden", mode = "n" },
    ...
    view_options = {
      ...
      is_hidden_file = function(name, bufnr)
        local m = name:match "^%." or name:match "__pycache__" or name:match "node_modules"
        return m ~= nil
      end,
        ...
        mappings = {
          n = {
            ["<Leader>-"] = {
              ...
              desc = require("astroui").get_icon("OilPlugin", 1, true) .. "Open folder in Oil",
            },
          },
        },
        autocmds = {
