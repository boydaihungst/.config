now(function()
  add { "https://github.com/rmagatti/auto-session" }
  ...
  require("auto-session").setup {
    opts = {
      ...
      bypass_save_filetypes = { "alpha", "dashboard", "snacks_dashboard", "ministarter" }, -- List of filetypes to bypass auto save when the only buffer open is one of the file types listed, useful to ignore dashboards
